...
all: $(PREFIXED_GEOS_OBJS)
	...
	$(AS) $(ARGS_KERNAL) -DCBDOS $(VERSION_DEFINE) -o kernal/drivers/editor_vera.o kernal/drivers/editor_vera.s
	...
	$(LD) -C rom.cfg -o rom.bin \
		...
		kernal/kernal.o kernal/editor/editor.o kernal/cpychr.o kernal/drivers/editor_vera.o kernal/drivers/ps2.o kernal/drivers/ps2kbd.o kernal/drivers/ps2mouse.o kernal/drivers/joystick.o kernal/drivers/clock.o kernal/drivers/rs232.o kernal/graph/graph.o kernal/fonts/fonts.o \
		monitor/monitor.o \
