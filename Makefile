...
#$(GEOS_BUILD_DIR)/kernal/kernal.bin: $(PREFIXED_GEOS_OBJS) geos/kernal/kernal_bsw.cfg
#	@mkdir -p $$(dirname $@)
#	$(LD) -C geos/kernal/kernal_bsw.cfg $(PREFIXED_GEOS_OBJS) -o $@ -m $(GEOS_BUILD_DIR)/kernal/kernal.map -Ln $(GEOS_BUILD_DIR)/kernal/kernal.lab
...
all: $(PREFIXED_GEOS_OBJS) geos/kernal/kernal_bsw.cfg
