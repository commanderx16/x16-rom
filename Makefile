...
all: $(PREFIXED_GEOS_OBJS)
	...
	$(AS) $(ARGS_BASIC) $(VERSION_DEFINE) -o basic/fplib.o basic/fplib.s
	...
	$(LD) -C rom.cfg -o rom.bin basic/basic.o basic/fplib.o kernal/kernal.o monitor/monitor.o cbdos/zeropage.o cbdos/fat32.o cbdos/util.o cbdos/matcher.o cbdos/sdcard.o cbdos/spi_rw_byte.o cbdos/spi_select_device.o cbdos/spi_deselect.o cbdos/main.o keymap/keymap.o charset/petscii.o charset/iso-8859-15.o kernsup/kernsup.o kernsup/irqsup.o $(PREFIXED_GEOS_OBJS) -Ln rom.txt -m rom.map
