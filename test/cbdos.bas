...
12 GOSUB1600
13 REM GOSUB1700 : C65 ONLY
14 REM GOSUB1800 : TODO: SHOULD RETURN STATUS 39
15 GOSUB1900:GOSUB2000:GOSUB2100
...
1820 OPEN15,8,15:INPUT#15,S,A$,X,Y:CLOSE15:IFS<>1THENSTOP
1830 CLOSE1
1899 DOS"U0>T":PRINT"OK":RETURN

1900 PRINT"19 - MAKE/REMOVE DIRECTORY: ",,;
1905 DOS"MD:DIR"
1915 OPEN15,8,15:INPUT#15,S,A$,X,Y:CLOSE15:IFS<>0THENSTOP
1920 DOS"RD:DIR
1925 OPEN15,8,15:INPUT#15,S,A$,X,Y:CLOSE15:IFS<>1THENSTOP
1930 IFX<>1THENSTOP
...
2025 OPEN15,8,15:INPUT#15,S,A$,X,Y:CLOSE15:IFS<>0THENSTOP
2030 PRINT#1,"HELLO":CLOSE1
2035 OPEN1,8,2,"//DIR/:FILE"
2037 OPEN15,8,15:INPUT#15,S,A$,X,Y:CLOSE15:IFS<>0THENSTOP
