...
1 F=15
2 REM 0 = 1541 FEATURE SET (BASE)
2 REM 1 = 1571 EXTRA FEATURES
3 REM 2 = CMD FD/HD EXTRA FEATURES
4 REM 4 = C65 DRIVE EXTRA FEATURES
5 REM 8 = X16 SD-CARD EXTRA FEATURES
...
3640 IFSTTHENSTOP
3650 IFF=2GOTO3699 : REM CMD FD/HD IS BUGGY
...
REM 3820 OPEN15,8,15:INPUT#15,S,S$,X,Y:CLOSE15:IFSTHENSTOP
3825 OPEN2,8,2,"FILE2"
REM 3830 OPEN15,8,15:INPUT#15,S,S$,X,Y:CLOSE15:IFSTHENSTOP
3840 INPUT#1,A$:IFA$<>"TWO"THENSTOP
3845 OPEN3,8,2,"FILE1"
REM 3850 OPEN15,8,15:INPUT#15,S,S$,X,Y:CLOSE15:IFSTHENSTOP
...
3950 OPEN15,8,15:INPUT#15,S,S$,X,Y:CLOSE15:IFS<>62THENSTOP
3955 DOS"RD:FILE2
