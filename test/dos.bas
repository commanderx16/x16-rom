...
4905 OPEN1,8,2,"FILE,P,W"
4910 FORI=1TO256:PRINT#1,"THIS IS A TEST STRING!         ":NEXT:CLOSE1
4915 OPEN1,8,2,"FILE,P,A"
4920 FORI=1TO256:PRINT#1,"APPENDED TEXT AT THE END       ":NEXT:CLOSE1
4925 OPEN1,8,2,"FILE,P,A"
4930 OPEN15,8,15,"P"+CHR$(2)+CHR$($00)+CHR$($10)+CHR$(0)+CHR$(0):CLOSE15
4935 PRINT#1,"OVERWRITTEN USING SET-POSITION!"
4940 CLOSE1
4945 OPEN1,8,2,"FILE,P,R"
4950 FORI=1TO128:INPUT#1,A$:IFA$<>"THIS IS A TEST STRING!         "THENSTOP
4955 NEXT
4950 FORI=1TO128:INPUT#1,A$:IFA$<>"THIS IS A TEST STRING!         "THENSTOP
4955 NEXT
4960 INPUT#1,A$:IFA$<>"OVERWRITTEN USING SET-POSITION!"THENSTOP
4965 FORI=1TO127:INPUT#1,A$:IFA$<>"THIS IS A TEST STRING!         "THENSTOP
4970 NEXT
4975 FORI=1TO256:INPUT#1,A$:IFA$<>"APPENDED TEXT AT THE END       "THENSTOP
4980 NEXT:CLOSE1
4990 DOS"S:FILE
